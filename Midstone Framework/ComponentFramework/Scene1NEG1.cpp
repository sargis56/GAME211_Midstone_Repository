...
Scene1NEG1::Scene1NEG1() : character(nullptr), characterMesh(nullptr), shaderPtr(nullptr), texturePtr(nullptr), boxMesh(nullptr), doorRight(nullptr), doorTexture(nullptr), floor(nullptr), floorTexture(nullptr),
...
Scene1NEG1::~Scene1NEG1() {}

bool Scene1NEG1::OnCreate() {
	//Room setup
...
void Scene1NEG1::HandleEvents(const SDL_Event& sdlEvent) {
	character->HandleEvents(sdlEvent);
}

int Scene1NEG1::SetScene() {
	return sceneNumber;
}

void Scene1NEG1::BuildCharacter() {
...
void Scene1NEG1::BuildAllEnemies() {
...
void Scene1NEG1::Update(const float deltaTime) {
...
bool Scene1NEG1::setSceneCleared() {
	return roomCleared;
}

void Scene1NEG1::getSceneCleared(const bool storedRoom_) {
	roomCleared = storedRoom_;
}

float Scene1NEG1::setCharacterHealth() {
	return health;
}

void Scene1NEG1::getCharacterHealth(const float storedHealth_) {
	health = storedHealth_;
}

Vec3 Scene1NEG1::setCharacterPos() {
	return character->getPos();
}

void Scene1NEG1::getCharacterPos(const Vec3 storedPos_) {
...
float Scene1NEG1::setCharacterSpeed() {
	return character->getSpeed();
}

void Scene1NEG1::getCharacterSpeed(const float storedSpeed_) {
	speed = storedSpeed_;
}

int Scene1NEG1::setWeapon() {
	return weapon;
}

void Scene1NEG1::getWeapon(const int storedWeapon_) {
	weapon = storedWeapon_;
}

void Scene1NEG1::OnDestroy() {
