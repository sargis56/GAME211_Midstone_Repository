...
Scene01Under::~Scene01Under() {}

bool Scene01Under::OnCreate() {
	//Room setup
...
void Scene01Under::HandleEvents(const SDL_Event& sdlEvent) {
	character->HandleEvents(sdlEvent);
}

int Scene01Under::SetScene() {
	return sceneNumber;
}

void Scene01Under::BuildCharacter() {
...
void Scene01Under::BuildAllEnemies() {
	...
	demon2->setPos(Vec3(4.0f, 1.0f, -15.0f));
...
void Scene01Under::Update(const float deltaTime) {
...
void Scene01Under::Render() const {
	/// Clear the screen
...
bool Scene01Under::setSceneCleared() {
	return roomCleared;
}

void Scene01Under::getSceneCleared(const bool storedRoom_) {
	roomCleared = storedRoom_;
}

float Scene01Under::setCharacterHealth() {
	return health;
}

void Scene01Under::getCharacterHealth(const float storedHealth_) {
	health = storedHealth_;
}

Vec3 Scene01Under::setCharacterPos() {
	return character->getPos();
}

void Scene01Under::getCharacterPos(const Vec3 storedPos_) {
...
float Scene01Under::setCharacterSpeed() {
	return character->getSpeed();
}

void Scene01Under::getCharacterSpeed(const float storedSpeed_) {
	speed = storedSpeed_;
}

int Scene01Under::setWeapon() {
	return weapon;
}

void Scene01Under::getWeapon(const int storedWeapon_) {
	weapon = storedWeapon_;
}

void Scene01Under::OnDestroy() {
