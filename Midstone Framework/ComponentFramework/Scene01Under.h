#ifndef SCENE01UNDER_H
#define SCENE01UNDER_H
#include "Scene.h"
#include "Vector.h"
#include "Matrix.h"
#include "Character.h"
...
class Scene01Under : public Scene {
private:
	//character pointers and variables
	Character* character;
	Mesh* characterMesh, * boxMesh, * doorMesh, * turretMesh, * demonMesh;
	float health, speed;
	int weapon;
	Vec3 returnedPos;
	//room setup pointers
	Room room;
	Door *doorLeft, *doorTop, *doorBottom;
	...
	DemonEnemy* demon1, * demon2;
	//Shader Pointer
	Shader* shaderPtr;
	//Texture Pointer
	Texture* texturePtr, *wallTexture, *floorTexture, *doorTexture, *healthUITexture, * turretTexture, * demonTexture;
	//Engine Variables
...
public:
	//Scene setup
	explicit Scene01Under();
	virtual ~Scene01Under();
