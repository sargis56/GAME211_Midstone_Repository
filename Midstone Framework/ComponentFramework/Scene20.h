...
private:
	...
	Character* character;
	Mesh* characterMesh, * boxMesh, * doorMesh, *turretMesh, *demonMesh, *spearMesh;
	float health, speed;
	int weapon;
	Vec3 returnedPos;
	//room setup pointers
	...
	Shader* shaderPtr;
	//Texture Pointer
	Texture* texturePtr, *wallTexture, *floorTexture, *doorTexture, *healthUITexture, *doorGoldTexture, *turretTexture, *demonTexture, *weaponTexture;
	//Texture* doorGold;
	//Engine Variables
