...
Scene12::Scene12() : character(nullptr), characterMesh(nullptr), shaderPtr(nullptr), texturePtr(nullptr), boxMesh(nullptr), doorLeft(nullptr), doorTexture(nullptr), floor(nullptr), floorTexture(nullptr),
...
void Scene12::HandleEvents(const SDL_Event& sdlEvent) {
	character->HandleEvents(sdlEvent);
}

int Scene12::SetScene() {
	return sceneNumber;
}

void Scene12::BuildCharacter() {
...
bool Scene12::setSceneCleared() {
	return roomCleared;
}

void Scene12::getSceneCleared(const bool storedRoom_) {
	roomCleared = storedRoom_;
}

float Scene12::setCharacterHealth() {
	return health;
}

void Scene12::getCharacterHealth(const float storedHealth_) {
	health = storedHealth_;
}

Vec3 Scene12::setCharacterPos() {
	return character->getPos();
}

void Scene12::getCharacterPos(const Vec3 storedPos_) {
...
float Scene12::setCharacterSpeed() {
	return character->getSpeed();
}

void Scene12::getCharacterSpeed(const float storedSpeed_) {
	speed = storedSpeed_;
}

int Scene12::setWeapon() {
	return weapon;
}

void Scene12::getWeapon(const int storedWeapon_) {
	weapon = storedWeapon_;
}

void Scene12::OnDestroy() {
