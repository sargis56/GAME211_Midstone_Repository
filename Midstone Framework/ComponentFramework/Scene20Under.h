#ifndef SCENE20UNDER_H
#define SCENE20UNDER_H
#include "Scene.h"
#include "Vector.h"
#include "Matrix.h"
#include "Character.h"
...
class Scene20Under : public Scene {
private:
	//character pointers and variables
	Character* character;
	Mesh* characterMesh, * boxMesh, * doorMesh, * demonMesh, * healthPotMesh, *zweiMesh;
	float health, speed;
	int weapon;
	Vec3 returnedPos;
	//room setup pointers
	...
	DemonEnemy *demon1, * demon2, * demon3, * demon4, * demon5;
	Zweihander* zwei;
	//Shader Pointer
	Shader* shaderPtr;
	//Texture Pointer
	Texture* texturePtr, *wallTexture, *floorTexture, *doorTexture, *healthUITexture, *doorGoldTexture, * demonTexture, * healthPotTexture, *weaponTexture;
	//Texture* doorGold;
	//Engine Variables
...
public:
	//Scene setup
	explicit Scene20Under();
	virtual ~Scene20Under();
