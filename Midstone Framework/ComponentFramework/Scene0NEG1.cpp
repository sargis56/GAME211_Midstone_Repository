...
Scene0NEG1::~Scene0NEG1() {}

bool Scene0NEG1::OnCreate() {
	//Room setup
...
void Scene0NEG1::HandleEvents(const SDL_Event& sdlEvent) {
	character->HandleEvents(sdlEvent);
}

int Scene0NEG1::SetScene() {
	return sceneNumber;
}

void Scene0NEG1::BuildCharacter() {
...
bool Scene0NEG1::setSceneCleared() {
	return roomCleared;
}

void Scene0NEG1::getSceneCleared(const bool storedRoom_) {
	roomCleared = storedRoom_;
}

float Scene0NEG1::setCharacterHealth() {
	return health;
}

void Scene0NEG1::getCharacterHealth(const float storedHealth_) {
	health = storedHealth_;
}

Vec3 Scene0NEG1::setCharacterPos() {
	return character->getPos();
}

void Scene0NEG1::getCharacterPos(const Vec3 storedPos_) {
...
float Scene0NEG1::setCharacterSpeed() {
	return character->getSpeed();
}

void Scene0NEG1::getCharacterSpeed(const float storedSpeed_) {
	speed = storedSpeed_;
}

int Scene0NEG1::setWeapon() {
	return weapon;
}

void Scene0NEG1::getWeapon(const int storedWeapon_) {
	weapon = storedWeapon_;
}

void Scene0NEG1::OnDestroy() {
