#ifndef SCENE10UNDER_H
#define SCENE10UNDER_H
#include "Scene.h"
#include "Vector.h"
#include "Matrix.h"
#include "Character.h"
...
class Scene10Under : public Scene {
private:
	//character pointers and variables
	Character* character;
	Mesh* characterMesh, * boxMesh, * doorMesh, * archerMesh, * turretMesh, *maulMesh;
	float health, speed;
	int weapon;
	Vec3 returnedPos;
	//room setup pointers
...
public:
	//Scene setup
	explicit Scene10Under();
	virtual ~Scene10Under();
